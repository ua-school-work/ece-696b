...
import edu.arizona.josesosa.creational.abstractfactory.TestFactory;
...
public class UserTest {
    ...
    protected Product makeProduct(String name) {
        ...
        return factory.makeProduct(name);
    }
    ...
    public void testAggregation() throws Exception {
        Cart cart = makeAnOrder();
        // With the Flyweight pattern, soap and anotherSoap are the same object
        // so we expect 4 items instead of 5
