...
class StoreStrategyTest {
    ...
    private static class TestStore extends Store {
        public TestStore(Distributor... distributors) {
            super(new TestStoreFactory(Arrays.asList(distributors)));
        }
    ...
    // Test implementation of StoreFactory for testing purposes
    private static class TestStoreFactory extends StoreFactory {
        private final List<Distributor> distributors;

        public TestStoreFactory(List<Distributor> distributors) {
